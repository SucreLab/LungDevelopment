...
```{r}
cdkn1a_plot <- FeaturePlot(epi_relabel, "Cdkn1a") +
        featureplot_theme() +
        theme(aspect.ratio=1,
              panel.background = element_rect(fill = "transparent", colour = "black"),
              plot.background = element_rect(color = "transparent", fill = "transparent"),
...
gridExtra::grid.arrange(egg::set_panel_size(p=cdkn1a_plot, width=unit(10, "cm"), height=unit(10, "cm")))
ggsave("./data/figures/epi/epi_cdkn1a_umap.png",
       egg::set_panel_size(p=cdkn1a_plot, width=unit(10, "cm"), height=unit(10, "cm")),
       dpi = 300, bg = "transparent",
       width=unit(6, "cm"), height=unit(5, "cm"))
```
