...
filename <- "./data/20221020_merged_devodata_sct.rds"
if (!file.exists(filename)) {
  if (!file.exists(filename)) {
    ...
    meso <- readRDS("./data/20221020_meso_labeled.rds")
    ...
    saveRDS(merged_seurat, "./data/20221020_merged_devodata.rds")
    rm(epi)
    rm(endo)
    rm(meso)
    gc()
  } else {
    merged_seurat <- readRDS("./data/20221020_merged_devodata.rds")
  }
