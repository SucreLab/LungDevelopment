...
print("# AnnData")
adata = scv.read("data/epi_data.h5ad")
...
adata_w_velo = scv.utils.merge(adata, anndata.concat([e12_loom,
                                                      ...
                                                      p14_1_loom,
                                                      p14_2_loom]))
adata_w_velo.write("data/epi_data_w_velo.h5ad")
...
scv.pp.moments(adata_w_velo, n_pcs=25, n_neighbors=25) # scv
